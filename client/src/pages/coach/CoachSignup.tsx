    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-6">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 text-ink-muted group-focus-within:text-accent-500 transition-colors" size={20} />
              <input
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 text-ink-muted group-focus-within:text-accent-500 transition-colors" size={20} />
              <input
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Trophy className="absolute left-4 top-1/2 -translate-y-1/2 text-ink-muted group-focus-within:text-accent-500 transition-colors" size={20} />
              <input
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Shield className="absolute left-4 top-1/2 -translate-y-1/2 text-ink-muted group-focus-within:text-accent-500 transition-colors z-10" size={20} />
              <select
                value={division} onChange={e => setDivision(e.target.value)} required
                className="w-full bg-surface/50 border border-white/5 rounded-2xl py-4 pl-12 pr-4 focus:outline-none focus:border-accent-500/50 transition-all text-white appearance-none cursor-pointer"
              >
                {DIVISIONS.map(d => (
        ...
        <p className="text-center mt-8 text-sm text-ink-muted">
          ...
          <Link to="/coach/login" className="text-accent-500 font-black uppercase tracking-widest hover:text-accent-400 transition-colors">
            Sign In
          </Link>
        </p>
      </motion.div>
